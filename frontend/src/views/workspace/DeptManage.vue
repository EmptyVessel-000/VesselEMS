<template>
  <div class="page-container">
    <div class="page-header">
      ...
      <p class="page-subtitle">管理企业组织架构与部门信息</p>
    </div>
    ...
    <div class="table-section">
      ...
      <el-table :data="pagedData" v-loading="tableLoading" stripe style="width:100%" row-key="id" :tree-props="{children:'children'}" @selection-change="handleSelectionChange">
...
<style scoped>
/* DeptManage 使用全局 .page-container / .page-header / .search-section / .table-section 样式 */
</style>