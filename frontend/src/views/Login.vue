...
.login-card { display: flex; width: 780px; max-width: 95vw; min-height: 460px; background: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); overflow: hidden; }
.login-brand { flex: 0 0 320px; background: linear-gradient(135deg, #1e293b 0%, #334155 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; color: #ffffff; padding: 40px; }
...
.login-form-area { flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px 48px; }
.form-title { font-size: 22px; font-weight: 600; color: #1f2937; margin-bottom: 32px; align-self: flex-start; }
.login-form { width: 100%; }
.login-btn { width: 100%; }
.register-link { font-size: 13px; color: #6b7280; margin-top: 8px; }
.register-link a { color: #2563eb; text-decoration: none; margin-left: 4px; }
.register-link a:hover { text-decoration: underline; }
@media (max-width: 640px) {
  .login-card { flex-direction: column; width: 360px; }
  .login-brand { flex: 0 0 auto; padding: 32px 24px; }
