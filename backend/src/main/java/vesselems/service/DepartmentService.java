...
import vesselems.repository.DepartmentRepository;
...
public class DepartmentService {
    ...
    public Department updateDepartment(Long id, Department updated) {
        ...
        if (updated.getDeptName() != null)
            department.setDeptName(updated.getDeptName());
        if (updated.getParentId() != null)
            department.setParentId(updated.getParentId());
        if (updated.getLeader() != null)
            department.setLeader(updated.getLeader());
        if (updated.getPhone() != null)
            department.setPhone(updated.getPhone());
        if (updated.getEmail() != null)
            department.setEmail(updated.getEmail());
